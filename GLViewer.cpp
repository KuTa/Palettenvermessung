...
void GLViewer::rotate(double angle, double axisX, double axisY, double axisZ)
{
	camera->rotate(angle, axisX, axisY, axisZ);
	//focusPosition[0] = x; focusPosition[1] = y; focusPosition[2] = z;
	updateGL();
}

void GLViewer::setPosition(double x, double y, double z)
{
...
void GLViewer::setCloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr newCloud)
{
	...
	focusPosition[0] = cx/cloudSize; 
	focusPosition[1] = cy/cloudSize; 
	focusPosition[2] = cz/cloudSize; 
